...
object `org.springframework:spring-jms:jar:3.2.11.RELEASE` extends _root_.mvnmod.builder.MavenCentralModule(
  ...
  `org.springframework:spring-tx:jar:3.2.11.RELEASE`
)
