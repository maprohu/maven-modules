...
object `org.apache.camel:camel-jms:jar:2.18.0` extends _root_.mvnmod.builder.MavenCentralModule(
  "org.apache.camel:camel-jms:jar:2.18.0",
  `org.apache.camel:camel-core:jar:2.18.0`,
  `org.slf4j:slf4j-api:jar:1.7.21`,
  `org.apache.camel:camel-spring:jar:2.18.0`,
  ...
  `org.springframework:spring-jms:jar:4.3.3.RELEASE`,
