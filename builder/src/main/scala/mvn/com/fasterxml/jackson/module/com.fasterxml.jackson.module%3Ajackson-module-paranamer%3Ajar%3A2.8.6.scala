...
object `com.fasterxml.jackson.module:jackson-module-paranamer:jar:2.8.6` extends _root_.mvnmod.builder.MavenCentralModule(
  "com.fasterxml.jackson.module:jackson-module-paranamer:jar:2.8.6",
