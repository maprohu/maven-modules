...
object `org.apache.directory.api:api-ldap-model:jar:1.0.0-M20` extends _root_.mvnmod.builder.MavenCentralModule(
  ...
  `org.apache.directory.api:api-asn1-ber:jar:1.0.0-M20`,
