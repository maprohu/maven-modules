...
object `com.typesafe.slick:slick-hikaricp_2.11:jar:3.1.1` extends _root_.jartree.util.CaseClassLoaderKey(
  jar = _root_.jartree.util.MavenJarKeyImpl("com.typesafe.slick:slick-hikaricp_2.11:jar:3.1.1"),
