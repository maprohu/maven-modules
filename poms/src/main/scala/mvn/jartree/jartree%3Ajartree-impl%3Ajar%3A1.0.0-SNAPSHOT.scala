...
object `jartree:jartree-impl:jar:1.0.0-SNAPSHOT` extends _root_.maven.modules.utils.MavenCentralModule(
  "jartree:jartree-impl:jar:1.0.0-SNAPSHOT",
  `org.scala-lang:scala-library:jar:2.11.8`,
  `jartree:jartree-util:jar:1.0.0-SNAPSHOT`,
  ...
  `com.lihaoyi:upickle_2.11:jar:0.4.1`,
  `com.lihaoyi:derive_2.11:jar:0.4.1`,
