...
object `org.apache.maven:maven-settings-builder:jar:3.2.5` extends _root_.jartree.util.CaseClassLoaderKey(
  jar = _root_.jartree.util.MavenJarKeyImpl("org.apache.maven:maven-settings-builder:jar:3.2.5"),
