...
object `org.jboss.shrinkwrap.resolver:shrinkwrap-resolver-impl-maven:jar:2.2.2` extends _root_.jartree.util.CaseClassLoaderKey(
  jar = _root_.jartree.util.MavenJarKeyImpl("org.jboss.shrinkwrap.resolver:shrinkwrap-resolver-impl-maven:jar:2.2.2"),
