...
object `org.scala-lang:scala-compiler:jar:2.11.6` extends _root_.jartree.util.CaseClassLoaderKey(
  jar = _root_.jartree.util.MavenJarKeyImpl("org.scala-lang:scala-compiler:jar:2.11.6"),
