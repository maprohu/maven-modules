...
object `org.springframework:spring-context:jar:4.2.0.RELEASE` extends _root_.jartree.util.CaseClassLoaderKey(
  jar = _root_.jartree.util.MavenJarKeyImpl("org.springframework:spring-context:jar:4.2.0.RELEASE"),
