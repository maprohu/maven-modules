...
object `org.springframework:spring-messaging:jar:4.1.6.RELEASE` extends _root_.jartree.util.CaseClassLoaderKey(
  jar = _root_.jartree.util.MavenJarKeyImpl("org.springframework:spring-messaging:jar:4.1.6.RELEASE"),
